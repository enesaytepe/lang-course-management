...
public sealed class ClassroomsApiController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(await _classroomService.GetListAsync(
            pageRequest,
            search,
            branchId,
            isActive,
    ...
    public async Task<ActionResult<ClassroomResponse>> GetById(
        Guid id,
        CancellationToken cancellationToken)
    {
    ...
    [ValidateAntiForgeryToken]
    [ProducesResponseType<ClassroomResponse>(StatusCodes.Status200OK)]
    public async Task<ActionResult<ClassroomResponse>> Delete(
        Guid id,
        CancellationToken cancellationToken)
    {
